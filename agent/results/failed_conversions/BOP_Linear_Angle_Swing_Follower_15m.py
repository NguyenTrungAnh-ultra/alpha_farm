...
class CustomStrategy(SimpleAlgorithm):
    def __algorithm__(self):
        ...
        self.smooth_period = int(getattr(self, 'smooth_period', 15))
        self.angle_period = int(getattr(self, 'angle_period', 22))
        self.bop_threshold = float(getattr(self, 'bop_threshold', 0.15))
        self.angle_threshold = float(getattr(self, 'angle_threshold', 22.5))

...
class CustomStrategy(SimpleAlgorithm):
    def __algorithm__(self):
        ...
        self.aroon_min = float(getattr(self, 'aroon_min', 40.0))
        self.cmo_period = int(getattr(self, 'cmo_period', 15))
        self.cmo_trigger = float(getattr(self, 'cmo_trigger', 22.5))
        self.expansion_mult = float(getattr(self, 'expansion_mult', 1.35))

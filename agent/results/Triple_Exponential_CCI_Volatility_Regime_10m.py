...
class CustomStrategy(SimpleAlgorithm):
    def __algorithm__(self):
        ...
        self.tema_period = int(getattr(self, 'tema_period', 28))
        self.cci_period = int(getattr(self, 'cci_period', 23))
        self.cci_bound = float(getattr(self, 'cci_bound', 85.0))
        self.natr_min = float(getattr(self, 'natr_min', 0.06))

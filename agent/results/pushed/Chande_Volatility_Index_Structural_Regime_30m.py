...
class CustomStrategy(SimpleAlgorithm):
    def __algorithm__(self):
        ...
        self.tema_period = int(getattr(self, 'tema_period', 50))
        self.cmo_period = int(getattr(self, 'cmo_period', 20))
        self.cmo_threshold = float(getattr(self, 'cmo_threshold', 15.0))

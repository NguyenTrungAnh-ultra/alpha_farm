...
class CustomStrategy(SimpleAlgorithm):
    def __algorithm__(self):
        ...
        self.aroon_threshold = float(getattr(self, 'aroon_threshold', 30.0))
        self.bb_period = int(getattr(self, 'bb_period', 28))
        self.bb_mult = float(getattr(self, 'bb_mult', 1.8))
        self.width_min = float(getattr(self, 'width_min', 0.007))
        self.exit_period = int(getattr(self, 'exit_period', 19))
        self.exit_mult = float(getattr(self, 'exit_mult', 3.1))

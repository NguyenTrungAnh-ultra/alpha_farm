...
class CustomStrategy(SimpleAlgorithm):
    def __algorithm__(self):
        ...
        long_setup = (close > prev_highest) & (candle_range > self.atr_multiplier * self.op.shift(atr, 1)) & (vol > 0)
        
        # Breakout below lowest low with strong candle
        short_setup = (close < prev_lowest) & (candle_range > self.atr_multiplier * self.op.shift(atr, 1)) & (vol > 0)
        ...
        flat_zone = exit_long | exit_short | (vol == 0)

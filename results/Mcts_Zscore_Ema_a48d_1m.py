...
class CustomStrategy(SimpleAlgorithm):
    def __algorithm__(self):
        ...
        alpha_val = (self.feat.zscore(self.feat.zscore(((self.feat.ema(high, timeperiod=20) - self.feat.vwap(high, low, close, volume)) / (self.feat.stddev(volume, timeperiod=20) + 1e-8)), timeperiod=30), timeperiod=14) > 2.5)

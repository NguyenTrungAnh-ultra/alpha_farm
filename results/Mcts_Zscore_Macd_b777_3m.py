...
class CustomStrategy(SimpleAlgorithm):
    def __algorithm__(self):
        ...
        alpha_val = (self.feat.zscore(self.feat.zscore((self.feat.macd(self.feat.three_black_crows(open_, high, low, close))[0] / (self.feat.macd(self.feat.morning_star(open_, high, low, close))[1] + 1e-8)), timeperiod=30), timeperiod=5) > 1.5)
        ...
        raw_pos = self.op.where(z_score > 2.0, 0.2, self.op.where(z_score < -2.0, -0.2, 0.0))

...
class CustomStrategy(SimpleAlgorithm):
    def __algorithm__(self):
        ...
        alpha_val = (self.feat.ema(self.feat.sma(self.feat.atr(high, low, close, timeperiod=10), timeperiod=14), timeperiod=5) + self.feat.dema(self.feat.tema(self.feat.atr(high, low, close, timeperiod=20), timeperiod=20), timeperiod=20))
        ...
        raw_pos = self.op.where(scaled > 0.5, 0.3, self.op.where(scaled < -0.5, -0.3, 0.0))

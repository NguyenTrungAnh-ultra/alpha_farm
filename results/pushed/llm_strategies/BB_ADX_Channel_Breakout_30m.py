...
class CustomStrategy(SimpleAlgorithm):
    def __algorithm__(self):
        ...
        self.bb_period = int(self.bb_period if 'bb_period' in self.__dict__ else 48)
        self.bb_std = float(self.bb_std if 'bb_std' in self.__dict__ else 1.0481551149618276)

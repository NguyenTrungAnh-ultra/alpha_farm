...
class CustomStrategy(SimpleAlgorithm):
    def __algorithm__(self):
        ...
        self.fast_period = int(self.fast_period if 'fast_period' in self.__dict__ else 23)
        self.slow_period = int(self.slow_period if 'slow_period' in self.__dict__ else 75)

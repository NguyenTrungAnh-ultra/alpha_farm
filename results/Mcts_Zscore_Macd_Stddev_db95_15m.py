...
class CustomStrategy(SimpleAlgorithm):
    def __algorithm__(self):
        ...
        alpha_val = (self.feat.zscore((self.op.diff(self.feat.macd(low)[0], periods=3) / (self.feat.stddev(self.feat.ema(self.feat.hammer(open_, high, low, close), timeperiod=60), timeperiod=14) + 1e-8)), timeperiod=14) > 0.5)

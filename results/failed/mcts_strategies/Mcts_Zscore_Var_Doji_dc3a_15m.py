...
class CustomStrategy(SimpleAlgorithm):
    def __algorithm__(self):
        ...
        alpha_val = (self.feat.zscore(((self.op.pct_change(low, periods=2) * self.feat.var(self.feat.doji(open_, high, low, close), timeperiod=5)) / (self.feat.stddev(volume, timeperiod=20) + 1e-8)), timeperiod=60) > 1.0)

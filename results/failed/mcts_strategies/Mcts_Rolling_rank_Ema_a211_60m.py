...
class CustomStrategy(SimpleAlgorithm):
    def __algorithm__(self):
        ...
        alpha_val = (self.feat.rolling_rank(self.feat.ema(self.feat.ema(high, timeperiod=5), timeperiod=20), window=10) - self.feat.roc(self.feat.atr(high, low, close, timeperiod=5), timeperiod=14))
        ...
        raw_pos = self.op.where(scaled > 0.5, 0.25, self.op.where(scaled < -0.5, -0.25, 0.0))

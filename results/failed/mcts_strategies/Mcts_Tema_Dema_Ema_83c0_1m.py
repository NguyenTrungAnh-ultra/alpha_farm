...
class CustomStrategy(SimpleAlgorithm):
    def __algorithm__(self):
        ...
        alpha_val = (self.feat.tema(self.feat.dema(self.feat.ema(open_, timeperiod=5), timeperiod=10), timeperiod=10) - self.feat.wma(self.feat.dema(self.feat.atr(high, low, close, timeperiod=14), timeperiod=20), timeperiod=5))

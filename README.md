...
graph TD
    ...
    subgraph Local Environment [Môi trường Local (Sandbox)]
        direction TB
    ...
    subgraph Web Environment [XNOQuant Web]
    ...
    style Local Environment fill:#f9f9f9,stroke:#333,stroke-width:2px
    style Web Environment fill:#e6f3ff,stroke:#333,stroke-width:2px

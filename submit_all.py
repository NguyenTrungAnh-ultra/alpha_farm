...
def main():
    ...
    if not py_files:
        print("No unpushed strategies found in agent/results/")
        return
        
    print(f"Found {len(py_files)} unpushed strategies. Starting submission...")
    ...
    for filepath in py_files:
        ...
        if success:
            print(f"[{filename}] SUCCESS! File moved to pushed/.")
        else:
            print(f"[{filename}] FAILED or ERRORED.")

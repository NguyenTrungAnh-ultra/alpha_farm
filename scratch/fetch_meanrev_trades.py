...
def fetch_meanrev_trades():
    with sync_playwright() as p:
        ...
        # Navigate to details
        details_url = "https://alpha.xnoquant.io/list?strategyId=KHsBRRvjYL&stage=train"
        ...
        async () => {
            try {
                ...
                const url = 'https://api.xnoquant.io/xalpha-api/v1/strategies/KHsBRRvjYL/stages/train/summary-table?limit=10000';
        ...
        output_path = "scratch/web_trades_meanrev.json"

...
from core_engine.BacktestEngine import XNOBacktestEngine, load_data, BacktestResult
...
class XNOPlatformEmulator:
    ...
    def load_strategy_from_file(self, filepath: str) -> type:
        ...
        try:
            from strategy_workflows.SubmitStrategies import format_code_for_xno
            clean_code = format_code_for_xno(raw_code)
        except ImportError:
            raise RuntimeError("Không thể import format_code_for_xno từ strategy_workflows.SubmitStrategies")
        ...
        module_code = "from core_engine.XnoEngine import SimpleAlgorithm\n\n" + clean_code
